...
* Xinyu Peng, Ziyang Zheng, Wenrui Dai, Duoduo Xue, **Shaohui Li**, Chenglin Li, Junni Zou, Hongkai Xiong, "Information-Theoretic Optimization for Task-Adapted Compressed Sensing Magnetic Resonance Imaging," *IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)*, 2026.
...
* **Shaohui Li**, Shuoyu Ma, Wenrui Dai\*, Nuowen Kan, Fan Cheng, Chenglin Li, Junni Zou, Hongkai Xiong. "Task-Adapted Learnable Embedded Quantization for Scalable Human-Machine Image Compression." *IEEE Transactions on Circuits and Systems for Video Technology (TCSVT)*, vol. 35, no. 5, pp. 4768-4783, May 2025. (JCR Q1, IF=11.1)

### 2024

* **Shaohui Li**, Wenrui Dai, Yimian Fang, Ziyang Zheng, Wen Fei, Hongkai Xiong\*. "Revisiting Learned Image Compression With Statistical Measurement of Latent Representations." *IEEE Transactions on Circuits and Systems for Video Technology (TCSVT)*, vol. 34, no. 4, pp. 2891-2907, Apr. 2024. (JCR Q1, IF=11.1)
* Xin Li, Wenrui Dai\*, **Shaohui Li**, Chenglin Li, Junni Zou, Hongkai Xiong\*. "3-D Point Cloud Attribute Compression with $p$-Laplacian Embedding Graph Dictionary Learning." *IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)*, vol. 46, no. 2, pp. 975-993, Feb. 2024. (JCR Q1, IF=18.6)
...
* Wenpeng Zhang, **Shaohui Li**, Lanfeng Wang, Yu Liu\*. "Efficient Multi-Agent Reinforcement Learning for Pursuit-Evasion Game of Unmanned Surface Vessels with a Faster Evader." *International Conference on Robotics, Control and Automation (ICRCA 2025)*, Shanghai, China, Mar. 7-9, 2025.

### 2024

* Han Li, **Shaohui Li**\*, Shuangrui Ding, Wenrui Dai\*, Maida Cao, Chenglin Li, Junni Zou, Hongkai Xiong. "Image Compression for Machine and Human Vision with Spatial-Frequency Adaptation." *European Conference on Computer Vision (ECCV 2024)*, Milan, Italy, pp. 382-399, Sept. 29-Oct. 4, 2024. (TOP)
* Nantian He, **Shaohui Li**, Zhi Li, Yu Liu\*, You He. "ReDiffuser: Reliable Decision-Making Using a Diffuser with Confidence Estimation." *International Conference on Machine Learning (ICML 2024)*, Vienna, Austria, pp. 17921-17933, July 21-27, 2024. (TOP)
...
* Shixin Hong, Yu Liu\*, Zhi Li, **Shaohui Li**, You He. "Multi-agent Collaborative Perception via Motion-aware Robust Communication Network." *IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR 2024)*, Seattle, USA, pp. 15301-15310, Jun. 17-21, 2024. (TOP)
* Han Li, **Shaohui Li**\*, Wenrui Dai\*, Chenglin Li, Junni Zou, Hongkai Xiong. "Frequency-Aware Transformer for Learned Image Compression." *International Conference on Learning Representations (ICLR 2024)*, Vienna, Austria, May 7-11, 2024. (TOP)
...
* Maida Cao, Wenrui Dai\*, **Shaohui Li**, Han Li, Chenglin Li, Junni Zou, Hongkai Xiong. "Entropy Relaxed Lattice Vector Quantization for Learned Image Compression." *IEEE Data Compression Conference (DCC’2024)*, Snowbird, UT, USA, pp. 548-548, Mar. 19-22, 2024.

### Before 2024

* Wenxin Tian, **Shaohui Li**, Wenrui Dai\*, Cewu Lu, Weisheng Hu, Lin Zhang, Junfeng Du, Hongkai Xiong. "Learned Progressive Image Compression With Spatial Autoregression." *IEEE International Conference on Visual Communications and Image Processing (VCIP 2023)*, Jeju, Korea, Republic of, Dec. 4-7, 2023. (Oral)
...
* Yimian Fang, Wen Fei, **Shaohui Li**, Wenrui Dai\*, Chenglin Li, Junni Zou, Hongkai Xiong. "Fully Integerized End-to-End Learned Image Compression." *IEEE Data Compression Conference (DCC’2023)*, Snowbird, UT, USA, pp. 337-337, Mar. 21-24, 2023.
* Rulin Huang, **Shaohui Li**, Wenrui Dai\*, Chenglin Li, Junni Zou, Hongkai Xiong. "Improving Optical Flow Inference for Video Colorization." *IEEE International Symposium on Circuits and Systems (ISCAS 2022)*, Austin, TX, USA, pp. 3185-3189, May 28 - June 1, 2022.
* Rulin Huang, **Shaohui Li**, Wenrui Dai\*, Jixiang Luo, Chenglin Li, Junni Zou, Hongkai Xiong. "Video Compression via Inter-frame Chroma Prediction." *IEEE Data Compression Conference (DCC’2022)*, Snowbird, Utah, USA, pp. 457-457, Mar. 22-24, 2022.
* Liewen Liao, **Shaohui Li**, Jixiang Luo, Wenrui Dai\*, Chenglin Li, Junni Zou, Hongkai Xiong. "Efficient Decoder for Learned Image Compression via Structured Pruning." *IEEE Data Compression Conference (DCC’2022)*, Snowbird, Utah, USA, pp. 464-464, Mar. 22-24, 2022.
* Xin Li, Wenrui Dai\*, **Shaohui Li**, Chenglin Li, Junni Zou, Hongkai Xiong. "Graph Dictionary Learning for 3-D Point Cloud Compression." *IEEE Data Compression Conference (DCC’2022)*, Snowbird, Utah, USA, pp. 463-463, Mar. 22-24, 2022.
* Maida Cao, Wenrui Dai, **Shaohui Li**, Chenglin Li, Junni Zou, Ying Chen, Hongkai Xiong. "Entropy Modeling via Gaussian Process Regression for Learned Image Compression." *IEEE Data Compression Conference (DCC’2022)*, Snowbird, Utah, USA, pp. 163-172, Mar. 22-24, 2022. (Oral)
* Liang Yuan, Jixiang Luo, **Shaohui Li**, Wenrui Dai\*, Chenglin Li, Junni Zou, Hongkai Xiong. "Learned Image Compression with Channel-Wise Grouped Context Modeling." *IEEE International Conference on Image Processing (ICIP 2021)*, Anchorage, Alaska, USA, pp. 2099-2103, Sept. 19-22, 2021.
* Jixiang Luo, **Shaohui Li**, Wenrui Dai\*, De Cheng, Gang Li, Chenglin Li, Junni Zou, Hongkai Xiong. "Lossless Compression for Video Streams with Frequency Prediction and Macro Block Merging." *IEEE Data Compression Conference (DCC’2021)*, Snowbird, UT, USA, pp. 353-353, Mar. 23-26, 2021.
* Ziyang Zheng, Shanghong Wang, **Shaohui Li**, Wenrui Dai\*, Junni Zou, Feifei Li, and Hongkai Xiong. "DSCR-Net: A Diffractive Sensing and Complex-Valued Reconstruction Network for Compressive Sensing." *IEEE International Symposium on Circuits and Systems (ISCAS 2020)*, Sevilla, Spain, pp. 1-5, Oct. 10-21, 2020.
* **Shaohui Li**, Ziyang Zheng, Wenrui Dai\*, Junni Zou, Hongkai Xiong. "Rev-AE: A Learned Frame Set for Image Reconstruction." *IEEE International Conference on Acoustics, Speech, and Signal Processing (ICASSP’2020)*, Barcelona, Spain, pp. 1823-1827, May 4-8, 2020. (Lecture)
* Jixiang Luo, **Shaohui Li**, Wenrui Dai\*, Yuhui Xu, De Cheng, Gang Li, Hongkai Xiong. "Noise-to-Compression Variational Autoencoder for Efficient End-to-End Optimized Image Coding." *IEEE Data Compression Conference (DCC’2020)*, Snowbird, UT, USA, pp.33-42, Mar. 24-27, 2020. (Oral)
* **Shaohui Li**, Ziyang Zheng, Wenrui Dai, Hongkai Xiong. "Lossy Image Compression with Filter Bank Based Convolutional Networks." *IEEE Data Compression Conference (DCC’2019)*, Snowbird, UT, USA, pp. 23-32, Mar. 26-29, 2019. (Oral)
